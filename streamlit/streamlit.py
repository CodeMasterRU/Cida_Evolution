...
years_france = [1999, 2000, 2001, 2003, 2007, 2009, 2012, 2015, 2018, 2019, 2020]
...
deaths_sa = [250000, 300000, 0, 360000, 370000, 350000, 0, 182400, 110000, 71000, 72000]

# Data for the total population in France
years_population_france = [2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020]
population_france = [61255360, 61605930, 61963620, 62311900, 62678430, 63059740, 63456870, 63852860, 64220250, 64579930, 64940830, 65296100, 65630690, 65951610, 66259010, 66553770, 66836150, 67106160, 67364360, 67611480, 67848160]

# Data for the total population in South Africa
years_population_sa = [2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020]
population_sa = [44913300, 45483340, 46104940, 46770280, 47438930, 48104400, 48737070, 49371900, 50024790, 50680860, 51122960, 51453820, 51913820, 52425160, 53006860, 53675560, 54300700, 54841550, 55380210, 55918440, 56463620]

# Calculate the proportion of deaths per population for each country
proportion_deaths_france = [d / p * 100 for d, p in zip(deaths_france, population_france)]
proportion_deaths_sa = [d / p * 100 for d, p in zip(deaths_sa, population_sa)]

# Plot the graph
plt.figure(figsize=(10, 6))
plt.plot(years_france, proportion_deaths_france, marker='o', linestyle='-', color='blue', label='France')
plt.plot(years_sa, proportion_deaths_sa, marker='o', linestyle='-', color='green', label='Afrique du Sud')
